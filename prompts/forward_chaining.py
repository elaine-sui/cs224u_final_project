...
def forward_ltsbs_template():
    ...
    forward_cot_template = dsp.Template(
        instructions="Use forward chaining to reason step by step over the facts and rules to determine whether the query is true or false",
        facts_and_rules=Facts_And_Rules(),
        query=Query(),
        proof=Proof(),
        answer=Answer(),
